...
{
    ops.RegisterServicesFromAssembly(typeof(CreateAuthorizeCodeCommand).Assembly);
});

builder.Services.AddScoped<IClientRepository, ClientRepository>();
builder.Services.AddScoped<IUserRepository, UserRepository>();
builder.Services.AddScoped<ICurrentUser, CurrentUserContext>();
builder.Services.AddScoped<IAuthorizationCodeStore, InMemoryAuthorizationCodeStore>();
